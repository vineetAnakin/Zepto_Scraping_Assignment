...
# Extract latitudes and longitudes from the nested arrays
...
def getProducts(store_id, categories):
    ...
    for subcategory_data in categories:
        ...
        # products_response_json = products_response.json().update({'subcategory_name': subcategory_data['name'], 'subcategory_id': subcategory_data['id']})
        # answer.append(products_response_json)
...
def getAnswer(latitude, longitude):
    ...
    return getProducts(store_id, categories)
...
products = getAnswer(latitude, longitude)
